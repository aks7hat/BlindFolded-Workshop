        ...
        <div className="flex items-center justify-center h-16 gap-12">
          ...
          <div className="flex items-center gap-2">
            ...
            <div>
              ...
              <div className="text-[13px] text-muted-foreground">Nagarro Gurugram, Level 7, South Wing</div>
            </div>
          </div>
          ...
          <div className="flex items-center gap-2">
            ...
            <div>
              ...
              <div className="text-[13px] text-muted-foreground">Sept 20, 2025 • 2:00 PM - 3:45 PM</div>
            </div>
          </div>
        </div>
      </div>
