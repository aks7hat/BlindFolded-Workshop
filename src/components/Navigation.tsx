      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          ...
          <div className="flex items-center space-x-4 md:space-x-8">
            <img src="/nagarro.png" alt="Company Logo" className="h-15 w-16 md:h-17 md:w-20 object-contain" />
            <img src="/FLO.png" alt="FLO 2025 Event Logo" className="h-10 w-20 md:h-14 md:w-25 object-contain" />
          </div>
